...
При первом открытии Studio покажет форму для подключения к базе данных. Используйте следующие данные:

**Вариант 1: Подключение извне (с вашего компьютера)**
- **Host:** `194.58.88.127`
- **Port:** `5432`
- **Database:** `postgres`
- **User:** `postgres`
...
**Вариант 2: Подключение изнутри Docker сети (если Studio поддерживает)**
- **Host:** `supabase`
- **Port:** `5432`
- **Database:** `postgres`
- **User:** `postgres`
